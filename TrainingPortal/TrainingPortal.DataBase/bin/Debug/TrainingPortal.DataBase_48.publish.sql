...
GO
ALTER TABLE [dbo].[Course] DROP CONSTRAINT [FK__Course__Category__4AB81AF0];
...
GO
ALTER TABLE [dbo].[Course] ALTER COLUMN [CategoryId] INT NULL;


GO
ALTER TABLE [dbo].[Course]
    ADD [AudienceId] INT NULL;
...
GO
PRINT N'Altering [dbo].[AddCourse]...';
...
RETURN 0
GO
PRINT N'Altering [dbo].[UpdateCourse]...';
...
END
GO
PRINT N'Refreshing [dbo].[DeleteCourse]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[DeleteCourse]';


GO
PRINT N'Refreshing [dbo].[GetCourse]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetCourse]';


GO
PRINT N'Refreshing [dbo].[GetCourses]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[GetCourses]';
