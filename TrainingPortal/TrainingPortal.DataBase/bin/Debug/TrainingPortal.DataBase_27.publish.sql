...
GO
PRINT N'Altering [dbo].[AddUserToRole]...';


GO
ALTER PROCEDURE [dbo].[AddUserToRole]
	@userId INT,
...
RETURN 0
GO
PRINT N'Altering [dbo].[GetUserRoles]...';


GO
ALTER PROCEDURE [dbo].[GetUserRoles]
	@userId INT
AS
	SELECT Name FROM Role WHERE Id = (SELECT * FROM UserRole WHERE UserId = @userId)
RETURN 0
GO
